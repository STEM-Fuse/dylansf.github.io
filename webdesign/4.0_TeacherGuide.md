...
#### Step List
Go through the list of steps the program needs to take. This is what students will implement. Have students identify where each stp is happening in the game.
#### Sample Page
...
Have students follow along with the lesson about how to create the `checkGuess()` function. Have students 
#### Documentation
